...
function logToConsole(type, sender, msgShort, _extras) {
  ...
  var extras = _objectSpread({}, getSentryExtras());
...
function getSentryExtras() {
  ...
  var rootSpan = activeSpan ? Sentry.getRootSpan(activeSpan) : undefined;
  var sentryTraceId = rootSpan ? Sentry.spanToTraceHeader(rootSpan) : undefined;
  var sentryBaggageId = rootSpan ? Sentry.spanToBaggageHeader(rootSpan) : undefined;
  return {
    trace: sentryTraceId,
